...
function install(basePath, fileNames) {
    return __awaiter(this, void 0, void 0, function* () {
        const { name: outDir } = config_1.mernshellConfig;
...
class MakeInstall {
    static install(basePath) {
        return __awaiter(this, void 0, void 0, function* () {
            let mainClass;
            const { template } = config_1.mernshellConfig;
